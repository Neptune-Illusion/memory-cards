...
**版本**: v0.3.0 | **状态**: Release-ready | **平台**: Desktop 1.5.0+ / Mobile 1.4.0+
...
```bash
npm install
npm test        # 182 个单测：parser / scheduler / anticheat / store / mobile / mobile-lifecycle / css-contract / release-contract / bugfix-0.1.1 / session-resume
